...
export function ClearTintToggle() {
    ...
    return (
        <TooltipWrapper label={isClear ? "Clear" : "Tinted"} asChild>
            ...
            >
                <div className="relative border h-5.5 w-5.5 rounded-full">
                    <div className="absolute top-0 left-0 h-full w-1/2 bg-background rounded-tl-full rounded-bl-full" />
                    <div className="absolute z-50 border h-2.5 w-2.5 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
